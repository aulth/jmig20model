        ...
        <div className='md:w-1/2 w-full'>
          ...
          <form onSubmit={handleOnSubmit} className='flex flex-col gap-2'>
            <div className='flex gap-1 items-center border border-orange-300 rounded'>
              <BiUser className=' text-lg ml-1' />
              <input type="text" name="name" onChange={handleOnChange} placeholder='Enter your name' className='p-1 w-full focus:outline-none border-none' id="" required />
            </div>
            <div className='flex gap-1 items-center border border-orange-300 rounded'>
              <AiOutlineMail className=' text-lg ml-1' />
              <input type="email" name="email" onChange={handleOnChange} placeholder='Email' className='p-1 w-full focus:outline-none border-none' id="" required />
            </div>
            <textarea name="message" onChange={handleOnChange} className='w-full h-32 p-1 border rounded focus:outline-none  border-orange-300' placeholder='Message..' id="" cols="30" rows="10" required></textarea>

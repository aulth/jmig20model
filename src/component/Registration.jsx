...
const Registration = () => {
  return (
    <div className="container mx-auto   mt-[61px] bg-white">
      ...
      <div className='w-full flex gap-8 justify-center md:flex-row items-center  flex-col py-20 md:px-20 px-4'>
        <button className="bg-white shadow-md rounded p-8 text-xl font-semibold ">
